module.exports = function (sails) {
  ...
  return {
    ...
    /**
     * Initialize this project's Gulp tasks
     ...
     *
     * @param {String} taskName - gulp task to run
     * @param {Function} cb - optional, fires when the Gulp task has been started (non-production) or finished (production)
     */
